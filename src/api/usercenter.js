...
/**
 * 用户浏览可供协作的报告 GET /api/employee/getAllCooperation
 * @returns {Promise<{msg: string, code: number, data: {reportList: [{ reportName: string, reportId: number, score: int, workerId: number}, { reportName: string, reportId: number, score: int, workerId: number}]}}>}
 */
